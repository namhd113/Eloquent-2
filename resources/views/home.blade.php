        ...
        <aside class="sidebar-left">
            <nav class="navbar navbar-inverse">
                <div class="navbar-header">
                    ...
                    <h1><a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span> QUẢN LÝ<span class="dashboard_text">Quản Lý Khách Hàng</span></a></h1>
                </div>
            ...
            <div class="col_3">
                <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            <h5><strong>Thành Phố </strong></h5>
                            <span><a href="{{route('cities.list')}}">  Danh sách Thành Phố</a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            ...
                            <span><a href="{{route('customers.list')}}">Danh sách Khách Hàng</a> </span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 widget widget1">
...
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/1.jpg')}}' class="img-responsive" alt=""/></div>--}}
...
{{--                            </div>--}}
{{--                            <div class="activity-row">--}}
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/4.jpg')}}' class="img-responsive" alt=""/></div>--}}
{{--                                <div class="col-xs-7 activity-desc">--}}
...
{{--                            </div>--}}
{{--                            <div class="activity-row">--}}
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/3.jpg')}}' class="img-responsive" alt=""/></div>--}}
{{--                                <div class="col-xs-7 activity-desc">--}}
...
{{--                            </div>--}}
{{--                            <div class="activity-row">--}}
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/2.jpg')}}' class="img-responsive" alt=""/></div>--}}
{{--                                <div class="col-xs-7 activity-desc">--}}
...
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/1.jpg')}}' class="img-responsive" alt=""/><span>06:01 AM</span></div>--}}
...
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/3.jpg')}}' class="img-responsive" alt=""/><span>06:02 AM</span></div>--}}
{{--                                <div class="clearfix"> </div>--}}
{{--                            </div>--}}
{{--                            <div class="activity-row activity-row1">--}}
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/1.jpg')}}' class="img-responsive" alt=""/><span>06:05 AM</span></div>--}}
{{--                                <div class="col-xs-5 activity-img1">--}}
{{--                                    <div class="activity-desc-sub">--}}
{{--                                        <h5>Michael Chris</h5>--}}
...
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-xs-3 activity-img"><img src='{{asset('backend/images/3.jpg')}}' class="img-responsive" alt=""/><span>06:20 PM</span></div>--}}
{{--                                <div class="clearfix"> </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <form action="#" method="post">--}}
...
{{--            </div>--}}
    ...
    <!--footer-->
    <div class="footer">
        <p>&copy; 2020 Glance Design Dashboard. Hoàng Lưu | Design by <a href="https://www.google.com.vn/?hl=vi" target="_blank">GooGle</a></p>
    </div>
    <!--//footer-->
</div>
